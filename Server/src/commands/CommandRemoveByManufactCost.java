...
public class CommandRemoveByManufactCost extends Command {
    ...
    public Response execute() {
        try {
            return new Response(getName(), context.productList.removeAllByManufactureCost((Long) arguments[0].getValue(), context.handlerDatabase.isExistingUser(login, password)));
        }
        catch (Exception e) {
