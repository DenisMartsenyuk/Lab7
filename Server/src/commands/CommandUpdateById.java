...
public class CommandUpdateById extends Command {
    ...
    public Response execute() {
        try {
            return new Response(getName(), context.productList.updateById((Integer) arguments[0].getValue(), (Product) arguments[1].getValue(), context.handlerDatabase.isExistingUser(login, password)));
        }
        catch (Exception e) {
